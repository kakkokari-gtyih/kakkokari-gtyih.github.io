<template>
    ...
    <main
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl gap-x-6 gap-y-4 w-full mx-auto my-6 px-4"
    >
        <a
            v-for="blog in props.blogs"
            class="flex flex-col gap-1.5 cursor-pointer group outline-none"
            :href="blog.href"
            tabindex="1"
        >
